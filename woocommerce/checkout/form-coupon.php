...
<div class="woocommerce-form-coupon-toggle">
    ...
    <a href="#" role="button" aria-label="<?php echo esc_attr__('Enter your coupon code', 'woocommerce'); ?>" aria-controls="woocommerce-checkout-form-coupon" aria-expanded="false" class="showcoupon">
        <div class="label">
            <?php esc_html_e('Add voucher', 'granola'); ?>
        </div>
        <div class="icon">
            <?php echo \Granola\SVG::get('icons/chevron-down.svg'); ?>
        </div>
    </a>
