            ...
            'fields' => [
                ...
                [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            'key' => 'field_order_essentials_requires_product_ids',
                            'label' => 'Only if basket also contains (specific products)',
                            'name' => 'requires_product_ids',
                            'type' => 'post_object',
                            'instructions' => 'Optional, and only needed when a category cannot tell two builds apart. The hexhead screw rate changes on a posts build, and the only thing distinguishing it from a DuoLift build is the post itself, which shares every category with the other Plas-Pro parts.',
                            'post_type' => ['product'],
                            'post_status' => ['publish'],
                            'return_format' => 'id',
                            'multiple' => 1,
                        ...
                        [
                            'key' => 'field_order_essentials_excludes_product_ids',
                            'label' => 'Skip if basket contains (specific products)',
                            'name' => 'excludes_product_ids',
                            'type' => 'post_object',
                            'instructions' => 'Optional. The counterpart to the field above, for the build that does NOT use the product.',
                            'post_type' => ['product'],
                            'post_status' => ['publish'],
                            'return_format' => 'id',
                            'multiple' => 1,
