...
\add_filter('wpseo_breadcrumb_links', __NAMESPACE__ . '\\add_installer_breadcrumb_step', 20);
\add_filter('wpseo_breadcrumb_links', __NAMESPACE__ . '\\add_distributor_breadcrumb_step', 20);
