...
<div <?= \Granola\Helpers::build_attributes($args['attributes']); ?>>
    ...
    <div class="map__listing__actions">
        ...
        <?php if (!empty($args['phone'])) { ?>
            <a class="map__listing__action map__listing__action--icon" data-map-action="phone" href="tel:<?= esc_attr(preg_replace('/[^\d+]/', '', (string) $args['phone'])); ?>" aria-label="<?= esc_attr__('Phone', 'granola'); ?>" title="<?= esc_attr__('Phone', 'granola'); ?>">
